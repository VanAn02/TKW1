  ...
  <v-app-bar app color="#3853D8" dark>
    ...
    >
      ...
      <v-list style="width:200px">
        <v-list-item
        >
          <v-list-item-title class="pa-2">Hồ sơ</v-list-item-title>
          <v-list-item-title class="pa-2">Đổi mật khẩu</v-list-item-title>
          <v-list-item-title class="pa-2">Đăng xuất</v-list-item-title>
        </v-list-item>
      </v-list>
    </v-menu>
